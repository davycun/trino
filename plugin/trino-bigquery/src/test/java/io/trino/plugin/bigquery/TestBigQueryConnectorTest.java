        ...
        extends BaseConnectorTest
{
    ...
    {
        assertQuery(
                "SELECT * FROM TABLE(bigquery.system.native_query(query => 'SELECT 1'))",
                "VALUES 1");
    }
    ...
    {
        assertQuery(
                "SELECT * FROM TABLE(bigquery.system.native_query(query => 'SELECT name FROM tpch.nation WHERE nationkey = 0'))",
                "VALUES 'ALGERIA'");
    }
    ...
    public void testNativeQuerySelectFromTestTable()
    {
        ...
        try {
            ...
            assertQuery(
                    "SELECT * FROM TABLE(bigquery.system.native_query(query => 'SELECT * FROM " + tableName + "'))",
                    "VALUES 1, 2");
        }
        finally {
    ...
    public void testNativeQuerySelectUnsupportedType()
    {
        ...
        try {
            ...
            assertThatThrownBy(() -> query("SELECT * FROM TABLE(bigquery.system.native_query(query => 'SELECT * FROM test." + tableName + "'))"))
    ...
    public void testNativeQueryCreateStatement()
    {
        ...
        assertThatThrownBy(() -> query("SELECT * FROM TABLE(bigquery.system.native_query(query => 'CREATE TABLE test." + tableName + "(n INTEGER)'))"))
    ...
    public void testNativeQueryInsertStatementTableDoesNotExist()
    {
        ...
        assertFalse(getQueryRunner().tableExists(getSession(), tableName));
        assertThatThrownBy(() -> query("SELECT * FROM TABLE(bigquery.system.native_query(query => 'INSERT INTO test." + tableName + " VALUES (1)'))"))
    ...
    public void testNativeQueryInsertStatementTableExists()
    {
        ...
        try {
            ...
            assertThatThrownBy(() -> query("SELECT * FROM TABLE(bigquery.system.native_query(query => 'INSERT INTO test." + tableName + " VALUES (3)'))"))
                    .hasMessage("Unsupported statement type: INSERT");
        }
        finally {
            onBigQuery("DROP TABLE IF EXISTS test." + tableName);
